...
if (IDF_TARGET STREQUAL "linux")
    # Linux headless (no SDL2) - uses LGFX_Sprite for in-memory composition
    ...
    file(GLOB LGFX_SRCS
         ...
         ${LGFX_ROOT}/src/lgfx/v1/platforms/framebuffer/*.cpp
...
if (IDF_TARGET STREQUAL "linux")
    # Use LGFX_LINUX_FB to skip SDL2 detection; Sprite works headless
    target_compile_definitions(${COMPONENT_LIB} PUBLIC LGFX_LINUX_FB)
    # Suppress specific warnings that occur in LovyanGFX on Linux builds
    target_compile_options(${COMPONENT_LIB} PRIVATE -Wno-maybe-uninitialized -Wno-parentheses)
endif()
